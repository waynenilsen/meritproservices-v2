---
name: rebase
description: Rebase the current feature branch onto main. Stacked-diff style — amends the single commit on the feature branch and force-pushes. For solo developer workflow with one-commit-per-branch.
---
